    ...
    return (
        <footer className="px-6 py-12 text-center space-y-4 pb-28">
            ...
            <div className="flex justify-center gap-6">
                <a href="https://www.facebook.com/propulsarproducciones" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-primary transition-colors hover:scale-110 transform">
                ...
                <a href="https://www.instagram.com/propulsarproducciones/" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-secondary transition-colors hover:scale-110 transform">
                ...
                <a href="https://www.tiktok.com/@propulsarproducciones" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-primary transition-colors hover:scale-110 transform">
                ...
                <a href="https://www.youtube.com/@propulsarproducciones" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-red-500 transition-colors hover:scale-110 transform">
